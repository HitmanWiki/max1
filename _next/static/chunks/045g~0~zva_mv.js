(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 35451, (e, t, r) => {
    ...
    function _(e, t, r) {
        this.props = e, this.context = t, this.refs = v, this.updater = r || x
    }
    ...
    w.constructor = j, m(w, _.prototype), w.isPureReactComponent = !0;
    var E = Array.isArray;
    ...
    function M(e, t, r) {
        ...
        return ! function e(t, r, n, i, a) {
            ...
            if (d) return a = a(t), d = "" === i ? "." + A(t, 0) : i, E(a) ? (n = "", null != d && (n = d.replace(H, "$&/") + "/"), e(a, r, n, "", function(e) {
                return e
            })) : null != a && (R(a) && (s = a, l = n + (null == a.key || t && t.key === a.key ? "" : ("" + a.key).replace(H, "$&/") + "/") + d, a = k(s.type, l, s.props)), r.push(a)), 1;
            d = 0;
            var p = "" === i ? "." : i + ":";
            if (E(t))
                for (var b = 0; b < t.length; b++) f = p + A(i = t[b], b), d += e(i, r, n, f, a);
            else if ("function" == typeof(b = null === (c = t) || "object" != typeof c ? null : "function" == typeof(c = g && c[g] || c["@@iterator"]) ? c : null))
                for (t = b.call(t), b = 0; !(i = t.next()).done;) f = p + A(i = i.value, b++), d += e(i, r, n, f, a);
            else if ("object" === f) {
    ...
    r.Activity = b, r.Children = {
    ...
    }, r.Component = _, r.Fragment = i, r.Profiler = s, r.PureComponent = j, r.StrictMode = a, r.Suspense = d, r.ViewTransition = h, r.__CLIENT_INTERNALS_DO_NOT_USE_OR_WARN_USERS_THEY_CANNOT_UPGRADE = O, r.__COMPILER_RUNTIME = {
        __proto__: null,
        c: function(e) {
        ...
        var n = m({}, e.props),
            o = e.key;
        if (null != t)
            for (u in void 0 !== t.key && (o = "" + t.key), t) C.call(t, u) && "key" !== u && "__self" !== u && "__source" !== u && ("ref" !== u || void 0 !== t.ref) && (n[u] = t[u]);
        ...
        var n, o = {},
            u = null;
        if (null != t)
            for (n in void 0 !== t.key && (u = "" + t.key), t) C.call(t, n) && "key" !== n && "__self" !== n && "__source" !== n && (o[n] = t[n]);

...
, 50740, (e, t, r) => {
    ...
    function M(e, t, r) {
        ...
        return !function e(t, r, n, i, a) {
            ...
            if (d)
                ...
                l = n + (null == a.key || t && t.key === a.key ? "" : ("" + a.key).replace(H, "$&/") + "/") + d,
                a = k(s.type, l, s.props)),
                r.push(a)),
                1;
            d = 0;
            var p = "" === i ? "." : i + ":";
    ...
    r.cloneElement = function(e, t, r) {
        ...
        if (null != t)
            ...
            t)
                C.call(t, u) && "key" !== u && "__self" !== u && "__source" !== u && ("ref" !== u || void 0 !== t.ref) && (n[u] = t[u]);
    ...
    r.createElement = function(e, t, r) {
        ...
        if (null != t)
            ...
            t)
                C.call(t, n) && "key" !== n && "__self" !== n && "__source" !== n && (o[n] = t[n]);

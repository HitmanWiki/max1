(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["object" == typeof document ? document.currentScript : void 0, 32061, (e, t, r) => {
    "use strict";
...
${t}`))
    ...
    function H(e) {
        ...
        if (t && r) switch (r.type) {
            ...
            case "prerender":
                {
                    let n = r.fallbackRouteParams;n && n.size > 0 && u.default.use((0, p.makeHangingPromise)(r.renderSignal, t.route, e));
                    break
                }
            case "prerender-ppr":
                {
  ...
  - Rerun the production build with \`next build --debug-prerender\` to generate better stack traces.`)
    ...
    Object.defineProperty(r, "__esModule", {
        ...
        get: function() {
            return function e(t) {
                if ((0, i.isNextRouterError)(t) || (0, o.isBailoutToCSRError)(t) || (0, u.isDynamicServerError)(t) || (0, s.isDynamicPostpone)(t) || (0, a.isPostpone)(t) || (0, n.isHangingPromiseRejectionError)(t) || (0, s.isPrerenderInterruptedError)(t)) throw t;
                t instanceof Error && "cause" in t && e(t.cause)
            }
        }
    });
    ...
    function y() {
        ...
        return (0, o.useMemo)(() => e ? new s.ReadonlyURLSearchParams(e) : null, [e])
    }
    ...
    function v(e = "children") {
        f ?.("useSelectedLayoutSegment()"), (0, o.useContext)(s.NavigationPromisesContext);
        let t = R(e);
    ...
    class f extends s.default.Component {
        ...
        render() {
            ...
            return null !== e && null !== t ? (0, i.jsx)(d, {
                redirect: e,
                redirectType: t,
                reset: () => this.setState({
                    redirect: null
